...
write.table(cbind(t(seqtab.nochim) , taxa), "MSC_seqtab-nochimtaxa.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
write.table(taxa,"MSC_taxa.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
q()
