...
write.csv(taxa_NoSingle, file="MSC_taxa_rar8000_NoSingle.csv")
write.csv(ASV_NoSingle, file="MSC_seqtab-nochimtaxa_rar8000_NoSingle.csv")
write.csv(meta_rar,file="MSC_meta_rar8000.csv")
```
